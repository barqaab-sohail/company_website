...
{
    public function home() { return view('site.home', ['projects'=>Content::whereType('project')->whereStatus('published')->latest('published_at')->take(6)->get()]); }
    ...
    public function projects() { return view('site.projects', ['projects'=>Project::with('featuredImage')->whereStatus('published')->orderBy('sort_order')->orderBy('id')->get()]); }
    public function project(string $slug) { return view('site.project', ['project'=>Project::with('images')->whereStatus('published')->where('slug',$slug)->firstOrFail()]); }
