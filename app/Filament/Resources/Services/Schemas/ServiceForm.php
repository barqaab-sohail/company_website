    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                FileUpload::make('image')->image()->imageResizeMode('contain')->imageResizeTargetWidth('1600')->imageResizeTargetHeight('1200')->disk('public')->directory('services')->maxSize(10240)->imagePreviewHeight('220')->helperText('JPG, PNG or WebP. Images are resized to a maximum of 1600 × 1200 pixels.'), Textarea::make('description')->columnSpanFull(),
